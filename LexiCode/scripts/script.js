...
// DRAG & DROP
// let fallenlassenErmöglichen = function (ev) {
//   ev.preventDefault();
// };

// let ziehen = function (ev) {
//   ev.dataTransfer.setData("text", ev.target.id);
// };

// let fallenlassen = function (ev) {
//   ev.preventDefault();
...
interact(".dropzone").dropzone({
  ...
  ondropactivate: function (event) {
    event.target.classList.add("drop-activate");
  },
  ondragenter: function (event) {
    let ziehbaresElement = event.relatedTarget;
    let dropzoneElement = event.target;
    dropzoneElement.classList.add("drop-ziel");
    ziehbaresElement.classList.add("kann-gedroppt-werden");
  },
  ondragleave: function (event) {
    event.target.classList.add("drop-ziel");
    event.relatedTarget.classList.remove("kann-gedroppt-werden");
  },
  // ondrop: function (event) {

  // },
  ondropdeactivate: function (event) {
    event.target.classList.remove("drop-aktivieren");
    event.target.classList.remove("drop-ziel");
  },
});
